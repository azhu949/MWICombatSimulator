...
const routes = [
    ...
    },
    {
        ...
        meta: { showCombatToolbar: false, navLabelKey: "common:menu.enhancement", navLabel: "Enhancement", navGroup: "tools", navOrder: 3 },
    },
    {
        path: "/skilling",
        name: "skilling",
        component: () => import("../pages/SkillingPage.vue"),
        meta: { showCombatToolbar: false, navLabelKey: "common:menu.skilling", navLabel: "Skilling", navGroup: "tools", navOrder: 4 },
    },
    {
        path: "/queue",
        name: "queue",
    ...
    },
    {
        ...
        meta: { showCombatToolbar: false, navLabelKey: "common:menu.guide", navLabel: "Guide", navGroup: "support", navOrder: 8 },
    },
    {
        path: "/settings",
        name: "settings",
