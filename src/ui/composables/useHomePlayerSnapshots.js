...
const STATUS_FALLBACKS = {
    ...
    "common:settingsPage.playerDeleteError":
        "Failed to delete player snapshot data. Check browser storage permissions.",
...
export function useHomePlayerSnapshots(blockPlayerConfigReplacement) {
    ...
    function save() {
        ...
        setStatus(
            result.ok
                ? "common:settingsPage.playerSaveSuccess"
                : result.messageKey || "common:settingsPage.playerSaveError",
