<template>
    <div class="surface-panel">
        ...
        <div class="mb-3 grid gap-3 sm:grid-cols-2">
            ...
            <label class="block">
                ...
                <Select v-model="runScopeProxy">
                    ...
                    <SelectContent>
                        <SelectItem
                            v-for="scope in simulator.availableRunScopes"
                            :key="scope.value"
                            :value="scope.value"
                        >
        ...
        >
            <label class="block">
                ...
                <Select v-model="simulator.simulationSettings.labyrinthHrid">
                    ...
                    <SelectContent>
                        <SelectItem
                            v-for="monster in simulator.options.labyrinths"
                            :key="monster.hrid"
                            :value="monster.hrid"
                        >
        ...
        <div
            v-if="
                simulator.simulationSettings.mode === 'zone' &&
                simulator.simulationSettings.runScope === 'all_solo_zones'
            "
            class="mb-3 rounded-md border border-border bg-muted/50 p-3"
        >
            <div class="mb-2 flex items-center justify-between gap-2">
