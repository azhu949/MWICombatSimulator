        ...
        <div class="space-y-3">
            ...
            <div class="rounded-md border border-border bg-muted/50 p-3">
                ...
                <p class="mt-2 text-xs text-muted-foreground">
                    {{
                        t(
                            "common:Experiment.dungeonStartWaveNotConnected",
                            "Start wave is not connected to worker runtime yet.",
                        )
                    }}
                </p>
            </div>
        ...
        for (let i = 0; i < cases.length; i += 1) {
            ...
            const payload = {
                ...
                zone:
                    entry.zone ||
                    (entry.zoneHrid
                        ? { zoneHrid: entry.zoneHrid, difficultyTier: Number(entry.difficultyTier || 0) }
                        : null),
