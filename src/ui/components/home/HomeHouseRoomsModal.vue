                        ...
                        <div v-else class="space-y-2">
                            ...
                            >
                                <div class="min-w-0">
                                    <p class="truncate text-sm font-medium text-foreground">
                                        {{
                                            getHouseRoomName(
                                                room.roomHrid,
                                                houseRoomDetailMap?.[room.roomHrid]?.name || room.roomHrid,
                                            )
                                        }}
                                    </p>
                                    <p class="mt-1 text-xs text-muted-foreground">
                                ...
                                <span class="text-sm font-semibold text-primary">{{
                                    formatUpgradeCost(room.subtotal)
                                }}</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="rounded-md border border-border bg-muted/50 p-4">
                <div class="mb-3 flex items-center justify-between gap-3">
                    ...
                    <span class="text-xs text-muted-foreground">{{
                        formatInt(houseRoomUpgradePreview.materials.length)
                    }}</span>
                </div>
                <div
                        ...
                        <TableHeader
                            ><TableRow class="border-b border-border text-xs uppercase text-muted-foreground"
                                ><TableHead class="px-2 py-2">{{
                                    t("common:vue.home.houseRooms.materialName", "Material")
                                }}</TableHead
                        ...
                        <TableBody
                            ><TableRow
                                ...
                                ><TableCell class="px-2 py-2">{{
                                    getItemName(
                                        material.itemHrid,
                                        itemDetailMap?.[material.itemHrid]?.name || material.itemHrid,
                                    )
                                }}</TableCell
