        ...
        <div class="surface-panel">
                ...
                <div v-for="slotIndex in 3" :key="`food-${slotIndex}`" class="grid gap-2">
                    ...
                    >
                        <label class="control-label">{{
                            t("common:vue.home.foodSlot", "Food", { index: slotIndex })
                        }}</label>
                        <SearchCombobox
                            ...
                            :more-results-label="
                                t(
                                    'common:vue.common.refineSearchMoreResults',
                                    'Refine the search to see {count} more results',
                                )
                            "
                            :max-results="60"
                        ...
                        <InlineTriggerEditor
                            ...
                            :blocked-message="
                                triggerController.isActive('food', slotIndex - 1) ? triggerBlockedMessage : ''
                            "
            ...
            <div class="mt-3 space-y-3">
                <div v-for="slotIndex in 3" :key="`drink-${slotIndex}`" class="grid gap-2">
                    ...
                    >
                        <label class="control-label">{{
                            t("common:vue.home.drinkSlot", "Drink", { index: slotIndex })
                        }}</label>
                        <SearchCombobox
                        ...
                        <InlineTriggerEditor
                            ...
                            :max-rules="MAX_TRIGGER_COUNT"
                            :blocked-message="
                                triggerController.isActive('drink', slotIndex - 1) ? triggerBlockedMessage : ''
                            "
            ...
            <div class="space-y-3">
                ...
                >
                    ...
                    <InlineTriggerEditor
                        ...
                        :max-rules="MAX_TRIGGER_COUNT"
                        :blocked-message="
                            triggerController.isActive('ability', slotIndex - 1) ? triggerBlockedMessage : ''
                        "
