  ...
  <div class="space-y-4">
    <div class="border-b border-border pb-3">
      ...
      <p class="mt-1 text-sm text-muted-foreground">
        {{
          t('common:vue.home.workspaceAdvancedDesc', 'Review the full derived combat attributes for the current build.')
        }}
      </p>
    </div>
        ...
        <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          ...
          >
            <div class="flex min-w-0 items-start justify-between gap-3">
              <p class="min-w-0 break-words text-sm font-medium leading-5 text-foreground/80" :title="entry.label">
                {{ entry.label }}
              </p>
              <p
