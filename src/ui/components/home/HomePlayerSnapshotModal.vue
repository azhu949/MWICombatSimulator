    ...
    >
        <div class="space-y-3">
            <p class="text-sm text-foreground/85">
                {{
                    t(
                        "common:settingsPage.playerDataDescription",
                        "Manually save/restore build data for 5 players only.",
                    )
                }}
            </p>
                    ...
                    <Table class="min-w-full text-sm"
                        ><TableHeader
                            ><TableRow class="border-b border-border text-left text-xs uppercase text-muted-foreground"
                                ...
                                ><TableHead class="px-2 py-2">{{
                                    t("common:settingsPage.playerSnapshotTableZone", "Zone")
                                }}</TableHead
                                ><TableHead class="px-2 py-2">{{
                        ...
                        ><TableBody
                            ><TableRow
                                ...
                                ><TableCell class="px-2 py-2">{{
                                    row.hasSnapshot ? row.simulationTime : "-"
                                }}</TableCell
                                ><TableCell class="px-2 py-2">{{
