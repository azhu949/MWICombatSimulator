            ...
            >
                ...
                <div v-if="card.details" class="grid grid-cols-[auto_1fr] gap-x-2 gap-y-1">
                    <span class="text-muted-foreground">{{
                        t("common:vue.home.levelEtaTotalExperience", "Total XP")
                    }}</span>
                    <span class="text-right">{{ card.details.totalExperience }}</span>
                    <span class="text-muted-foreground">{{
                        t("common:vue.home.levelEtaRequiredExperience", "XP Needed")
                    }}</span>
                    <span class="text-right">{{ card.details.requiredExperience }}</span>
                    <span class="text-muted-foreground">{{
                        t("common:vue.home.levelEtaRequiredTime", "Time Needed")
                    }}</span>
    ...
    for (const levelKey of levelKeys) {
        ...
        if (eta.status === "missing_current_experience") {
            ...
            cards.push({
                ...common,
                message: t(
                    "common:vue.home.levelEtaOutOfRange",
                    "Target level is outside the current experience table range.",
                ),
            });
