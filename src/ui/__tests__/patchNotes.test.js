...
describe("patchNotes", () => {
    it("publishes the concise bilingual 2.0.9 through 2.0.0 entries first", () => {
        ...
        expect(zhEntries[0]).toMatchObject({
            entryId: "2026年8月18日（v2.0.9）",
            label: "2026年8月18日（v2.0.9）",
        });
        ...
        expect(zhPreviousEntries[0].notes).toEqual([
        ...
        expect(enPreviousEntries[0].notes).toEqual([
        ...
        expect(zhPreviousEntries[1].notes).toHaveLength(4);
        ...
        expect(enPreviousEntries[1].notes).toHaveLength(4);
        ...
        expect(zhPreviousEntries[2].notes).toHaveLength(3);
        ...
        expect(enPreviousEntries[2].notes).toHaveLength(3);
        ...
        expect(zhPreviousEntries[4].notes).toContain(
        ...
        expect(enPreviousEntries[4].notes).toContain(
        ...
        expect(zhPreviousEntries[7].notes).toContain(
            "食物、饮品和技能新增内联触发条件编辑。"
        );
        ...
        expect(enPreviousEntries[7].notes).toContain(
            "Added inline trigger-condition editing for food, drinks, and abilities."
        );
        expect(zhPreviousEntries[8]).toMatchObject({
            entryId: "2026年8月8日（v2.0.0）",
            label: "2026年8月8日（v2.0.0）",
        });
        expect(zhPreviousEntries[8].notes).toHaveLength(3);
        expect(enPreviousEntries[8]).toMatchObject({
            entryId: "2026年8月8日（v2.0.0）",
            label: "August 8, 2026 (v2.0.0)",
        });
        expect(enPreviousEntries[8].notes).toHaveLength(3);
    });
