...
import { buildTriggerChangeLabel, formatQueueTriggerDetailLine } from '../queueTriggerPresentation.js';
...
describe('queueTriggerPresentation', () => {
  ...
  it('includes readable trigger rule summaries when both sides are custom', () => {
    expect(
      ...
      "Trigger Fireball: Target Enemy's # of Active Units >= 1 / Target Enemy's Current Hp >= 85 -> Target Enemy's # of Active Units >= 1 / Target Enemy's Current Hp >= 60",
    );
  });
});
