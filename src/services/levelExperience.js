...
const SKILL_LEVEL_EXPERIENCE_TABLE = Object.freeze(
  (Array.isArray(levelExperienceTable) ? levelExperienceTable : []).map((value) => toFiniteNumber(value, 0)),
);
...
export { SKILL_LEVEL_EXPERIENCE_TABLE, MIN_SKILL_LEVEL, MAX_SKILL_LEVEL };
