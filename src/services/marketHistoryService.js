export const MARKET_HISTORY_MANIFEST_URL =
  'https://raw.githubusercontent.com/azhu949/mwi-market-history/master/data/manifest.json';
...
export function createMarketHistoryService({
  ...
  const getCachedValue = (entry) => (entry && entry.expiresAt > Date.now() ? entry.value : undefined);
