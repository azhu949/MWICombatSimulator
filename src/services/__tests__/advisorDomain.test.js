...
describe("advisorDomain", () => {
    it("normalizes filters and creates the default advisor state", () => {
        expect(normalizeAdvisorFilters({
    ...
    it("formats partial advisor scan errors", () => {
        expect(buildAdvisorPartialErrorText("quick scan", [{ id: "a" }, { id: "b" }]))
            .toBe("2 target(s) failed during quick scan. Showing successful results only.");
