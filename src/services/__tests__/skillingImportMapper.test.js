...
describe('skillingImportMapper', () => {
  ...
  it('keeps malformed optional collections empty', () => {
    ...
    expect(profile.buffsBySource.guild).toEqual(
      Object.fromEntries(skillingData.actionTypeHrids.map((actionTypeHrid) => [actionTypeHrid, []])),
    );
  });
});
