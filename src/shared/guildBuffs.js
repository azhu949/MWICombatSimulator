...
export const combatGuildBuffHrids = Object.freeze(combatGuildBuffDetails.map((detail) => String(detail.hrid)));
...
export function normalizeGuildBuffLevels(rawLevels, fallbackLevels = {}) {
  ...
  const fallback =
    fallbackLevels && typeof fallbackLevels === 'object' && !Array.isArray(fallbackLevels) ? fallbackLevels : {};

  return Object.fromEntries(
    combatGuildBuffHrids.map((guildBuffHrid) => {
