...
class SimResult {
    ...
    setScrollUsageContext(allowed = true, ignoredReason = "") {
        ...
        this.scrollUsage.ignoredReason = this.scrollUsage.allowed
            ? ""
            : String(ignoredReason || "scrolls_not_allowed");
    }
    ...
    recordScrollOpen(playerHrid, itemHrid, metadata = {}, activeDurationNs, exhausted) {
        ...
        const configuredQuantity = Object.prototype.hasOwnProperty.call(details, "configuredQuantity")
            ...
            : (Object.prototype.hasOwnProperty.call(details, "quantity") ? details.quantity : undefined);
        ...
        const exhaustedValue = Object.prototype.hasOwnProperty.call(details, "exhausted")
            ? details.exhausted
            : exhausted;
    ...
    recordMonsterDeath(playerOrHrid, monsterOrHrid, contextOrCount = {}, killCount = 1) {
        if (playerOrHrid && typeof playerOrHrid === "object") {
            ...
            const hasExplicitContext = Boolean(
                ...
                && Object.keys(explicitContext).length > 0
            );
    ...
    recordMonsterDeathFromContext(playerHrid, monsterHrid, context = {}, killCount = 1) {
        ...
        const matchesContext = (bucket) => Boolean(bucket && (
        ...
        const existing = matchesContext(latestBucket)
            ? latestBucket
            : buckets.find(matchesContext);
        if (existing) {
